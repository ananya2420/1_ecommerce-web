...
const Products = () => {
  return (
    ...
    <div className="container">
        ...
        <p data-aos="fade-up" className="text-xs text-grey-400"> Our biggest sale is here! Enjoy up to 70% off on all products. From essentials to luxury, shop your favorites before they’re gone </p>
